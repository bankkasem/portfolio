...
// Hoist static SVG icons outside component
const FrontendIcon = (
  <svg
    className="w-6 h-6"
    fill="none"
...
// Hoist static skill categories data
...
const Skills = memo(function Skills() {
  ...
  // Memoize skill categories to prevent recreation
    ...
    <section id="skills" className="section-padding bg-background-alt">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 text-center">
          <p className="text-muted mb-6">{t("alwaysLearning")}</p>
